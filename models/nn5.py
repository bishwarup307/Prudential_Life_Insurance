# -*- coding: utf-8 -*-
"""
Created on Wed Feb 10 13:26:05 2016
...
def load_data():
    ...
    print "\nLoading..."
    alldata = pd.read_csv("Data/alldata_scaled.csv")
...
def fit_model(ptr, pte):
    ...
    eval_matrix = pd.DataFrame(columns = ["Fold", "Id", "ground_truth", "nn5_preds"])        
